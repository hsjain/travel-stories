...
const Attraction = () => {
    ...
    const getAllItems = () => {
        axios.get('http://localhost:8080/api/attraction/' + queryString.split("=")[1].split("/")[0] + '/' + queryString.split("=")[2])
        .then((response) => {
    ...
    const updateItems = () => {
        ...
        for (let i = 0; i < items.length; i++){
            if (items[i]["name"] === input){
                ...
                const response = axios.put('http://localhost:8080/api/attraction/' + items[i]["name"] + '/' + queryString.split("=")[1].split("/")[0] + '/' + queryString.split("=")[2], helper)
        ...
        if (!flag){
            ...
            axios.post('http://localhost:8080/api/attraction', helper)
        ...
        <div className='body'> 
            ...
            <div className="box">
                <div className="additem">
                    <input type="text" id="inputf"className="additem" onChange={(e) => setInput(e.target.value)} placeholder='Add an Attraction...'/>
